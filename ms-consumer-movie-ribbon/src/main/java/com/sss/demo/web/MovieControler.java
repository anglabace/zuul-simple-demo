...
public class MovieControler {
    ...
    public void logUserInstance(){
        ServiceInstance serviceInstance = this.loadBalancerClient.choose("itmuch-provider-user");
        //打印当前选择哪个节点
        MovieControler.LOGGER.info("{}:{}:{}",serviceInstance.getServiceId(),serviceInstance.getHost(),serviceInstance.getPort());
    }
}
